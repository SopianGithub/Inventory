<button wire:loading.attr="disabled" wire:loading.class="!cursor-wait" type="submit" class="outline-none inline-flex justify-center items-center group transition-all ease-in duration-150 focus:ring-2 focus:ring-offset-2 hover:shadow-sm disabled:opacity-80 disabled:cursor-not-allowed rounded gap-x-2 text-sm px-4 py-2     ring-primary-500 text-primary-500 border border-primary-500 hover:bg-primary-50
    dark:ring-offset-slate-800 dark:hover:bg-slate-700 ml-4">
    
    Log in

    
    </button>
<?php /**PATH /Applications/MAMP/htdocs/inventory/storage/framework/views/e5afc965a345434f46e1838f01fc8a5d.blade.php ENDPATH**/ ?>