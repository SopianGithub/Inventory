		...
		<div class="flex items-center justify-between">
			<div class="flex items-center justify-start">
				...
				<a href="/" class="flex ml-2 md:mr-24">
					<img
						src="/storage/image/ideaspace.png"
				...
				<?php if (isset($component)) { $__componentOriginal5f191bbb41a2ae6f55e7ecfcf1baac0d = $component; } ?>
<?php $component = App\View\Components\Template\SearchInput::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('template.search-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Template\SearchInput::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal5f191bbb41a2ae6f55e7ecfcf1baac0d)): ?>
<?php $component = $__componentOriginal5f191bbb41a2ae6f55e7ecfcf1baac0d; ?>
<?php unset($__componentOriginal5f191bbb41a2ae6f55e7ecfcf1baac0d); ?>
<?php endif; ?>
			</div>
				...
				<div class="flex items-center ml-3">
					...
					>
						...
						<ul class="py-1" role="none">
                            <li>
								<a
                                    href="<?php echo e(route('profile.show')); ?>" :active="request()->routeIs('profile.show')"
							...
							<li>
								<a
									href="#"
									class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
									role="menuitem"><?php echo e(__('API Tokens')); ?></a
								>
							</li>
                            <?php endif; ?>
...
</nav><?php /**PATH /Applications/MAMP/htdocs/inventory/resources/views/components/template/nav-bar-sidebar.blade.php ENDPATH**/ ?>