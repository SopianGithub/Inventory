<div class="relative"
    ...
    <span name="wireui.select.option.data">JSON.parse(atob('eyJsYWJlbCI6IlBlbmRpbmciLCJ2YWx1ZSI6IjEifQ=='))</span>
    
    </div>
                <div name="wireui.select.option">
    <span name="wireui.select.option.data">JSON.parse(atob('eyJsYWJlbCI6IkluIFByb2dyZXNzIiwidmFsdWUiOiIyIn0='))</span>
    
    </div>
                <div name="wireui.select.option">
    <span name="wireui.select.option.data">JSON.parse(atob('eyJsYWJlbCI6IlN0dWNrIiwidmFsdWUiOiIzIn0='))</span>
    
    </div>
                <div name="wireui.select.option">
    <span name="wireui.select.option.data">JSON.parse(atob('eyJsYWJlbCI6IkRvbmUiLCJ2YWx1ZSI6IjQifQ=='))</span>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-slate-100','x-ref' => 'search','x-model.debounce.750ms' => 'search','x-on:keydown.arrow-down.prevent' => '$event.shiftKey || getNextFocusable().focus()','x-on:keydown.arrow-up.prevent' => 'getPrevFocusable().focus()','shadowless' => true,'right-icon' => 'search','placeholder' => trans('wireui::messages.searchHere')]); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/inventory/storage/framework/views/703b3cc5792ec2bee9fd1567b8979766.blade.php ENDPATH**/ ?>