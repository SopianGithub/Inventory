        ...
        <div class="flex flex-col items-center mt-16">
            <div wire:poll="fetchData">
                <div class="animate__animated animate__pulse animate__infinite">
                    <span class="text-6xl font-semibold"><?php echo e($recentSubscribers); ?></span>
                </div>
            </div>
...
<?php $__env->startPush('jsChartPurchase'); ?>
<script>
    // var options = {
    //     chart: {
    //         type: 'line',
    ...
    //     series: [{
    //         name: 'Subscribers',
    //         data: <?php echo json_encode($subscribers, 15, 512) ?>
    //     }],
    //     xaxis: {
    //         categories: <?php echo json_encode($days, 15, 512) ?>
    //     }
    // }
    ...
    document.addEventListener('livewire:load', () => {
        window.livewire.find('<?php echo e($_instance->id); ?>').on('refreshChart', (chartData) => {
            chart.updateSeries([{
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/inventory/resources/views/livewire/dashboard/sales-purchase.blade.php ENDPATH**/ ?>